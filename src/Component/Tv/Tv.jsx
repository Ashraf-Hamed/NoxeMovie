...
export default function Tv() {
  ...
  function getTvShow(page) {
    return axios.get(
      `https://api.themoviedb.org/3/trending/tv/week?api_key=eba8b9a7199efdcb0ca1f96879b83c44&page=${page}`
    );
  }


  let { data, isLoading ,refetch} = useQuery("TvShow", () =>  getTvShow(page));
