...
export default function TrendingTvShow() {
    ...
    async function getTvShow() {
      let { data } = await axios.get(
        `https://api.themoviedb.org/3/trending/tv/week?api_key=eba8b9a7199efdcb0ca1f96879b83c44`
      );
        ...
        <>
          <div className="container">
            ...
            <div className="row my-5 gx-2">
              {trendTVShow ? (
                <Slider {...settings}>
                  {trendTVShow.slice(0, 10).map((movie, index) => (
            ...
            <Link className='moreBtnStyle' to='/Tv'>More</Link>
          </div>
        </>
      );
}
